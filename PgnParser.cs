...
namespace SrcChess {
    ...
    public class PgnParserException : System.Exception {
        ...
        public          PgnParserException(string strMsg, string strCodeInError) : base(strMsg) { CodeInError = strCodeInError; }
    }
...

        ...
        //
        /// <summary>
        /// FindCastling:                   Find a castle move
        /// </summary>
...

        ...
        //
        /// <summary>
        /// ParseFEN:                       Parse FEN definition into a board representation
        /// </summary>

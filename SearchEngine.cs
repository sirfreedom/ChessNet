...

        ...
        //  
        //*********************************************************     
        protected List<ChessBoard.MovePosS> SortMoveList(List<ChessBoard.MovePosS> moveList, int[] arrPoints) {
...

        ...
        //  
        //*********************************************************     
        protected abstract bool FindBestMove(ChessBoard chessBoard, SearchMode searchMode, ChessBoard.PlayerColorE ePlayerColor, List<ChessBoard.MovePosS> moveList, int[]arrIndex, ref ChessBoard.MovePosS moveBest, out int iPermCount, out int iCacheHit, out int iMaxDepth);

        //*********************************************************     
        //
        /// <summary>
        ...
        public bool FindBestMove(ChessBoard chessBoard, SearchMode searchMode, ChessBoard.PlayerColorE ePlayerColor, out ChessBoard.MovePosS moveBest, out int iPermCount, out int iCacheHit, out int iMaxDepth) {
            ...
            bRetVal                     = FindBestMove(chessBoard, searchMode, ePlayerColor, moveList, arrIndex, ref moveBest, out iPermCount, out iCacheHit, out iMaxDepth);
            return(bRetVal);
        }

...

    ...
    public class TransTable {
        ...
        static TransTable[]                     m_arrTransTable;
        /// <summary>Size of the translation tables</summary>
        static int                              m_iTransTableSize = 1000000;
...

        ...
        static public int TranslationTableSize {
            get {
                return(m_iTransTableSize);
            }
            set {
                if (m_iTransTableSize != value) {
                    m_iTransTableSize = value;
...

        ...
        public void Reset() {
            m_iCacheHit     = 0;
            //Array.Clear(m_arrTransEntry, 0, m_arrTransEntry.Length);
            m_iGen++;
        }
    }
}
